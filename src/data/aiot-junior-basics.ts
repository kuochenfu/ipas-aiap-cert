...
import { questionMeta } from "./meta/aiot-junior-basics";
 ...
 */
export const questions: Question[] = applyQuestionMeta(
  resolvePastExamExplanations(past as Question[], explanations),
  questionMeta,
);
