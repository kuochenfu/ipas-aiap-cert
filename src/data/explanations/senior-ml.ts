...
export const explanations: Record<string, string> = {
  ...
  "senior-ml-114-2-q47":
    "本題要找出能正確以 KNN 搭配交叉驗證並輸出準確率的程式組合，官方答案為 B（程式碼 A、程式碼 C）。正確組合需正確建立 KNN 分類器、正確呼叫 cross_val_score（或等效交叉驗證流程）並輸出準確率；B 與 D 中含有資料切割或交叉驗證函數使用錯誤而無法正確輸出，故正解為 A、C 的組合（B）（L233 交叉驗證）。",
  "senior-ml-114-2-q48":
    "標準化流程 X_train -= X_train.mean(axis=0) 將各特徵平均調為 0（A 正確），X_train /= X_train.std(axis=0) 將各特徵標準差調為 1。但標準化是把資料轉為平均 0、標準差 1，並非壓縮到 0~1 之間——惟官方答案為 C（A、C），依官方判定 A 與 C 為正解組合。標準化屬特徵縮放而非特徵選擇（E 錯），F 的修正寫法會破壞標準化亦錯，故依官方選 C（L233 特徵縮放；C 對 0~1 之敘述存疑，依官方答案，中低信心）。",
  "senior-ml-114-2-q49":
