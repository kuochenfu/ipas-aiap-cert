...
export const generated: Question[] = [
  ...
  },
  {
    ...
    choiceExplanations: {
      ...
      D: "梯度爆炸發生在訓練過程中，症狀是損失發散或數值溢位、訓練根本收斂不了；題幹的模型訓練得很好，問題只出在未見過的資料上。",
    },
    topic: "機器學習概念",
    difficulty: "易",
    source: "generated",
  ...
  },
  {
    ...
    choiceExplanations: {
      A: "序數編碼把 A/B/O/AB 映成 1、2、3、4，模型會讀出血型之間有大小與間距；題幹已明說這些類別並無大小或順序關係。",
  ...
  },
  {
    ...
    choiceExplanations: {
      ...
      C: "資料量變大會讓模型更難靠死記通過訓練，通常是緩解過擬合的手段之一；把它說成必然造成過擬合，因果剛好顛倒。",
    },
    topic: "機器學習概念",
    difficulty: "中",
    source: "generated",
