...
export const generated: Question[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "B", text: "員工到職時的固定資產折舊" },
      { id: "C", text: "公司商標的一次性註冊規費" },
      { id: "D", text: "模型推論（Inference）的 API 呼叫量與雲端運算費用" },
    ],
    answer: "D",
    explanation:
      "生成式 AI 上線後會隨使用量持續產生模型推論的 API 呼叫與雲端運算費用，屬於應納入的持續性營運成本（D）。會議室租借（A）與商標註冊（C）為一次性且與 AI 運作無直接關聯；員工固定資產折舊（B）並非 AI 解決方案的營運成本項目。",
    topic: "生成式 AI 導入評估規劃",
    difficulty: "中",
    source: "generated",
  },
  ...
  },
  {
    ...
    subjectId: "junior-genai",
    prompt:
      "在 No code / Low code 平台中，常以「模型（Model）」作為應用的抽象核心，其主要意義為下列何者？",
    choices: [
      { id: "A", text: "指深度學習中的神經網路權重檔" },
      { id: "B", text: "專指實體機房中的伺服器硬體配置" },
      { id: "C", text: "指最終使用者操作介面的色彩配置" },
      { id: "D", text: "以結構化方式描述資料、流程與規則，作為應用組裝的抽象藍圖" },
    ],
    answer: "D",
    explanation:
      "在 No code / Low code 平台中，「模型」是以結構化方式描述資料、流程與規則的抽象藍圖，讓平台據以組裝應用（D）。它並非深度學習權重（A）、伺服器硬體（B）或介面色彩配置（C），這些都與此抽象概念不同。",
    topic: "No code / Low code 概念",
    difficulty: "中",
    source: "generated",
  },
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "C", text: "對需高度客製、極端效能的系統提供無限的底層控制" },
      { id: "D", text: "以視覺化方式提升流程可視性與協作" },
    ],
    answer: "C",
    explanation:
      "No code / Low code 的優勢在於縮短時程（A）、降低參與門檻（B）與提升流程可視性（D）；但其抽象化也限制了對底層的控制，因此對需高度客製、極端效能的系統並不能提供「無限的底層控制」（C），這正是其限制而非優勢。",
    topic: "No code / Low code 概念",
    difficulty: "中",
    source: "generated",
  },
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "因為沒有程式碼，所以完全不需要、也無法進行任何測試" },
    ...
    answer: "B",
    explanation:
      "即使少寫或不寫程式碼，No code / Low code 應用仍應對流程邏輯、資料正確性與整合介面進行驗證與測試（B）。認為無法測試（A）、可免除驗證責任（C）或只測顏色（D）都會忽略應用實際運作的正確性風險。",
    topic: "No code / Low code 概念",
    difficulty: "中",
    source: "generated",
  },
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "讓公司看起來很創新就好，無須設定可衡量結果" },
      { id: "B", text: "盡量導入越多 AI 功能越好，不限定範圍" },
      { id: "C", text: "等同業都做完之後再決定要不要做" },
      { id: "D", text: "於三個月內讓客服首次回覆時間縮短並維持回覆品質達標，並以指標驗收" },
    ],
    answer: "D",
    explanation:
      "良好的導入目標應具體、可衡量、有時程與驗收指標，例如於三個月內縮短客服首次回覆時間並維持品質達標（D）。追求「看起來創新」（A）、無範圍地堆功能（B）或一味觀望（C）都欠缺可評估與可驗收的基準。",
    topic: "生成式 AI 導入評估規劃",
    difficulty: "中",
    source: "generated",
  },
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "僅看哪一個的官網介面顏色較好看" },
      { id: "B", text: "綜合比較資料隱私可控性、總體成本、維運能力與客製需求" },
      { id: "C", text: "只要選名氣最大的品牌即可，不需評估" },
      { id: "D", text: "完全依個人喜好，無須考量資料安全" },
    ],
    answer: "B",
    explanation:
      "自建開源模型與商用 API 的取捨，應綜合比較資料隱私可控性、總體成本、維運能力與客製需求等關鍵構面（B）。只看介面顏色（A）、只看品牌名氣（C）或純憑個人喜好而忽略資料安全（D）都不是負責任的解決方案選擇評估。",
    topic: "生成式 AI 導入評估規劃",
    difficulty: "難",
    source: "generated",
  },
