...
export const generated: Question[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "D", text: "只要管線一次建置成功，後續即可省去版本控管與回溯機制" },
    ],
    answer: "A",
    explanation:
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "C", text: "固定執行環境後，可一併使線上輸入資料的分布不再隨時間改變" },
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "C", text: "提供現成特徵以加速建模，但仍需訓練資料與標註才能完成模型訓練" },
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "僅監看主機 CPU 使用率與磁碟空間是否足夠" },
      { id: "B", text: "推論延遲與吞吐量、錯誤率，以及預測分布與輸入資料漂移情形" },
      { id: "C", text: "僅統計每日 API 呼叫總次數作為唯一健康指標" },
      { id: "D", text: "只在使用者回報問題時才被動檢查模型輸出" },
    ],
    answer: "B",
    explanation:
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "可減少呼叫端因模型改版而被迫改動，但模型本身仍需更新與重新部署" },
