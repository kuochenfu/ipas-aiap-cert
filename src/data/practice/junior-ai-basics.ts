...
export const practiceQuestions: Question[] = [
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "這類資料帶有標籤但欄位不固定，屬於半結構化資料，格式如JSON、XML" },
      { id: "B", text: "只要資料是以文字檔案儲存，不論格式為何，就歸類為非結構化資料" },
      { id: "C", text: "因為每筆紀錄都有時間戳記與設備代號欄位，這類資料應歸類為結構化資料" },
      { id: "D", text: "不同設備附加欄位不同，代表這類資料本質上屬於非結構化資料、缺乏任何格式規則" },
    ],
    answer: "A",
    explanation:
    ...
    choiceExplanations: {
      B: "判別依據是資料是否具有標籤化的層級結構，而非儲存的檔案格式本身；JSON雖以文字檔儲存，仍帶有明確的欄位標籤，屬半結構化而非非結構化。",
      C: "結構化資料要求所有紀錄的欄位型態與數量完全一致，此處不同設備附加欄位並不相同，不符合完全結構化的定義。",
      D: "這類資料仍具備欄位標籤與層級（JSON鍵值結構），並非全無格式規則，因此不屬於非結構化資料，而是半結構化資料。",
    },
    topic: "L11201 資料基本概念與來源",
    difficulty: "中",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "只要影像檔案有拍攝時間與地點的中繼資料，就必須歸類為結構化資料" },
      { id: "B", text: "影像資料因檔案較大，判別型態的依據是檔案大小而非有無固定欄位結構" },
      { id: "C", text: "影像資料經過壓縮處理後，就會具備固定的欄位與標籤結構，成為結構化資料" },
      { id: "D", text: "這類影像資料沒有固定欄位或標籤，屬於非結構化資料，需靠影像辨識判讀" },
    ],
    answer: "D",
    explanation:
      "非結構化資料指沒有預先定義欄位或固定格式的資料，例如影像、音訊、自由文字，通常需仰賴影像辨識、自然語言處理等技術才能萃取資訊。空拍影像本身不具備欄位結構，即使檔案帶有拍攝時間等中繼資料，影像內容本體仍屬非結構化資料。",
    choiceExplanations: {
      A: "少量中繼資料（如拍攝時間）不能使整份影像檔案轉為結構化資料，判別依據是影像內容本身是否具有固定欄位結構，而非有無附帶中繼資料。",
      B: "判別結構化與否的依據是資料有無固定欄位與格式規則，與檔案大小無關，即使是小檔案的自由格式文字仍屬非結構化資料。",
      C: "壓縮只改變儲存方式，不會為影像資料建立起欄位與標籤的結構，壓縮後的影像仍屬非結構化資料。",
    },
    topic: "L11201 資料基本概念與來源",
    difficulty: "易",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "這項特徵屬於Veracity（真實性），因為資料量龐大代表其可信度較高" },
      { id: "B", text: "這項特徵屬於Volume（數量），指資料規模龐大到超出傳統處理方式負荷" },
      { id: "C", text: "這項特徵屬於Value（價值），因為資料量越大代表能萃取出的商業價值越高" },
      { id: "D", text: "這項特徵屬於Variety（多樣性），因為感測器數量多、資料種類自然增加" },
    ],
    answer: "B",
    explanation:
    ...
    choiceExplanations: {
      A: "Veracity（真實性）指資料是否可信、有無雜訊或誤差，與資料量的大小是兩個不同構面，資料量大不代表可信度較高。",
      C: "Value（價值）指從資料中萃取出的商業效益，資料量龐大只是原始素材多，未必等於能萃取的價值也隨之提高，兩者屬不同構面。",
      D: "Variety（多樣性）指資料型態與來源的種類多寡，此情境描述的是「量測數據總量龐大」，是規模問題而非種類問題，屬於Volume而非Variety。",
    },
    topic: "L11201 資料基本概念與來源",
    difficulty: "中",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "B", text: "這項特徵屬於Variety（多樣性），因為報價與成交紀錄是兩種不同型態的資料" },
      { id: "C", text: "這項特徵屬於Volume（數量），因為每毫秒產生資料，代表資料總量會是五者中最龐大的" },
      { id: "D", text: "這項特徵屬於Value（價值），因為即時處理的資料通常比歷史資料更具商業價值" },
    ],
    answer: "A",
    explanation:
    ...
    choiceExplanations: {
      B: "Variety（多樣性）指資料型態與來源的種類多寡，報價與成交紀錄同屬數值型的交易資料，型態相近，此情境描述的重點是處理速度極快，屬於Velocity而非Variety。",
      C: "資料產生速度快不代表資料總量（Volume）必然是五者中最龐大的，速度與數量是不同構面，須分別評估。",
      D: "即時處理雖有助掌握市場先機，但「處理速度快」本身與「資料價值高低」是兩個不同構面，不能直接畫上等號。",
    },
    topic: "L11201 資料基本概念與來源",
    difficulty: "中",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "這種特徵屬於Velocity（速度），因為四種資料來源同時蒐集，代表處理速度極快" },
      { id: "B", text: "這種特徵屬於Veracity（真實性），因為來源種類多，資料的可信程度會隨之提高" },
      { id: "C", text: "這種特徵屬於Volume（數量），只要來源種類夠多，資料總量就會達到大數據等級" },
    ...
    choiceExplanations: {
      A: "資料來源種類多與處理速度快慢是不同構面，同時蒐集多種資料不代表必須即時處理，此情境的重點在型態多元而非速度。",
      B: "Veracity（真實性）指資料本身有無雜訊或誤差，來源種類多寡與資料可信度高低並無必然關聯，農民手寫筆記反而可能主觀誤差較大。",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "這項問題屬於Volume（數量），因為雜訊讀數會使資料總筆數大幅增加" },
      { id: "B", text: "這項問題屬於Velocity（速度），因為雜訊讀數通常會拖慢資料傳輸的速度" },
      { id: "C", text: "這項問題屬於Veracity（真實性），指資料的可信程度，需清洗才能提升品質" },
      { id: "D", text: "這項問題屬於Value（價值），只要先移除所有感測器資料，就能解決可信度不足的問題" },
    ],
    answer: "C",
    explanation:
    ...
    choiceExplanations: {
      A: "雜訊讀數是既有資料筆數中「品質不佳」的部分，並不會使資料總筆數因此暴增，資料量多寡屬於Volume而非此處的品質問題。",
      B: "雜訊讀數影響的是資料的可信程度，與資料傳輸速度快慢是不同構面，線路老化產生的量測誤差不必然拖慢傳輸。",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "這種現象屬於Volume（數量），只要持續蒐集更多點擊紀錄，可用資訊比例就會提高" },
      { id: "B", text: "這種現象屬於Value（價值），指資料量大不等於價值高，需經萃取才能取得具分析意義的資訊" },
      { id: "C", text: "這種現象屬於Variety（多樣性），因為點擊紀錄的欄位種類繁多，代表資料本身价值已經很高" },
      { id: "D", text: "這種現象屬於Veracity（真實性），指點擊紀錄的數量越多，代表資料的可信程度越高" },
    ],
    answer: "B",
    explanation:
    ...
    choiceExplanations: {
      A: "持續蒐集更多點擊紀錄只會增加資料總量（Volume），不會自動提高可用資訊的比例，價值萃取仍需仰賴特徵篩選等分析工作。",
      C: "欄位種類繁多屬於Variety（多樣性）的範疇，種類多寡與資料本身的分析價值高低並無必然關聯，多數欄位可能仍無助於預測目標。",
      D: "Veracity（真實性）指資料是否可信、有無雜訊，與資料筆數多寡是不同構面，點擊紀錄數量多不代表其可信程度就一定較高。",
    },
    topic: "L11201 資料基本概念與來源",
    difficulty: "中",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "兩批資料都屬於自有產品資料，因為公司對外部網站頁面同樣擁有完整使用權利" },
      { id: "B", text: "兩批資料都應歸類為網路爬蟲資料，因為兩者最終都是透過網路傳輸取得的" },
      { id: "C", text: "灌溉裝置回傳的用水量紀錄屬於網路爬蟲資料，行情頁面內容屬於自有產品資料" },
      { id: "D", text: "灌溉裝置回傳的用水量紀錄屬於自有產品資料，行情頁面則屬於網路爬蟲資料" },
    ],
    answer: "D",
    explanation:
    ...
    choiceExplanations: {
      A: "公司對自家灌溉裝置回傳的資料擁有完整所有權，但對外部交易網站的頁面內容並無所有權，僅是以程式擷取公開內容，兩者性質不同，不能都歸為自有產品資料。",
      B: "灌溉裝置的用水量紀錄是自家產品運作過程中直接產生、回傳給公司的資料，屬於自有產品資料，並非透過程式擷取他人網站取得的爬蟲資料。",
      C: "兩者的對應恰好相反——用水量紀錄是自有產品資料，行情頁面內容才是網路爬蟲取得的資料。",
    },
    topic: "L11201 資料基本概念與來源",
    difficulty: "中",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "第一批屬於感測器網路資料、第二批屬於公開API、第三批屬於外部購買資料" },
      { id: "B", text: "第一批屬於外部購買資料、第二批屬於感測器網路資料、第三批屬於公開API資料" },
      { id: "C", text: "三批資料雖然皆用於工廠內部分析，性質上仍應視為自有產品資料" },
      { id: "D", text: "第一批屬於公開API資料、第二批屬於外部購買資料、第三批屬於感測器網路資料" },
    ],
    answer: "A",
    explanation:
    ...
    choiceExplanations: {
      B: "對應錯置——溫濕度感測器持續量測回傳的資料屬於感測器網路資料，而非外部購買；付費向供應商取得的故障統計資料庫才是外部購買資料，而非公開API。",
      C: "感測器網路、公開API、外部購買三種來源型態各有不同的取得方式與權利關係，即使最終都用於工廠內部分析，也不能因用途相同就一律視為自有產品資料。",
      D: "對應錯置——溫濕度感測器資料屬於感測器網路，向開放平台呼叫取得的天氣資料屬於公開API，付費取得的資料庫才是外部購買，三者對應皆與此選項相反。",
    },
    topic: "L11201 資料基本概念與來源",
    difficulty: "難",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "資料整合的核心目的正是統一調整各系統資料的保存期限，這是整合專案不可或缺的一環" },
      { id: "B", text: "資料整合的目的與資料保存期限彼此無關，兩者在資料治理上不應同時規劃或討論" },
      { id: "C", text: "資料整合的目的是打破系統孤島、建立一致的客戶視圖，統一保存期限並非其核心目的" },
      { id: "D", text: "資料整合不過是把各系統資料集中儲存在同一個檔案中，不涉及格式、定義或欄位的一致化" },
    ],
    answer: "C",
    explanation:
    ...
    choiceExplanations: {
      A: "保存期限的訂定屬於資料保存政策與法遵留存規範的範疇，並非資料整合專案的核心目的，把它列為整合的核心目標會模糊整合真正要解決的孤島問題。",
      B: "保存期限與資料整合雖非同一件事，但兩者在資料治理架構下仍可能相關聯（例如整合後仍須遵循各類資料的留存規範），並非完全無關、不可同時討論。",
      D: "資料整合不只是物理上集中儲存，還須處理格式、定義與欄位的一致化，才能建立可信賴的單一客戶視圖，並非單純合併檔案。",
    },
    topic: "L11201 資料基本概念與來源",
    difficulty: "難",
    source: "generated",
  ...
  // ── L11202 資料整理與分析流程（11 題）────────────────────────────
  {
    ...
    choices: [
      { id: "A", text: "方案一屬於ELT、方案二屬於ETL，兩者差別在於轉換發生於倉儲之外或之內" },
      { id: "B", text: "方案一屬於ETL、方案二屬於ELT，差異在轉換發生於載入倉儲之前或之後" },
      { id: "C", text: "兩種方案的本質其實相同，不過是流程步驟的先後順序不同，並無專屬名稱之分" },
      { id: "D", text: "兩種方案的差異只在於是否使用雲端或地端倉儲，與轉換步驟的先後順序無關" },
    ],
    answer: "B",
    explanation:
    ...
    choiceExplanations: {
      A: "對應恰好顛倒——方案一先清洗轉換再載入，屬於ETL；方案二先載入再轉換，才是ELT。",
      C: "ETL與ELT在轉換步驟的時間點與位置有實質差異，各有專屬名稱與適用情境，並非只是順序不同、無區別意義。",
      D: "兩者的核心差異在於轉換步驟發生於載入之前（ETL）或之後（ELT），而非使用雲端或地端倉儲這項基礎設施的選擇。",
    },
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "B", text: "刪除有缺值的整筆紀錄，是任何比例的缺值都應採用的標準作法" },
      { id: "C", text: "以全體學生的最高分填補缺值，可確保分析結果不會低估整體學習成效" },
      { id: "D", text: "可考慮以中位數或平均數插補，缺值比例低，對整體分布影響有限" },
    ],
    answer: "D",
    explanation:
    ...
    choiceExplanations: {
      ...
      B: "是否刪除整筆紀錄需視缺值比例與資料量而定，並非任何比例下都應採用；當缺值比例低且與分析目標無關時，插補通常是更合適的作法。",
      C: "以最高分填補會人為推升這些學生的成績，同樣扭曲整體分布，使分析結果高估整體學習成效，並非「確保不低估」的合理理由。",
    },
    topic: "L11202 資料整理與分析流程",
    difficulty: "中",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "只要某筆交易金額超過全體交易金額計算出的平均值，就應該視為離群值" },
      { id: "B", text: "只要交易金額的Z-score絕對值超過3，就屬於IQR方法判定的離群值" },
      { id: "C", text: "金額低於Q1減1.5倍IQR或高於Q3加1.5倍IQR，視為離群值" },
      { id: "D", text: "只要交易金額低於Q1或高於Q3，不論距離多少，就視為離群值" },
    ],
    answer: "C",
    explanation:
    ...
    choiceExplanations: {
      A: "單純超過平均值並非IQR方法的判定依據，平均值容易受極端值拉動，IQR方法是以四分位數為基礎設定門檻。",
      B: "Z-score絕對值超過3是另一種離群值判定方法（Z-score法），依賴平均數與標準差，並非IQR方法的判定方式。",
      D: "IQR方法設有1.5倍IQR的緩衝範圍，只要落在Q1至Q3之間、甚至略微超出但未達1.5倍IQR的距離，仍不視為離群值，並非只要低於Q1或高於Q3就一律判定。",
    },
    topic: "L11202 資料整理與分析流程",
    difficulty: "難",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "Z-score指讀數與平均值相差的標準差倍數，數值越大代表越偏離集中趨勢" },
      { id: "B", text: "Z-score方法不需要計算平均值與標準差，只需比較讀數與中位數的差距" },
      { id: "C", text: "Z-score方法只適用於資料呈右偏分布的情境，不適用於近似常態分布的資料" },
      { id: "D", text: "Z-score的門檻值固定為3，任何資料集與應用情境都必須採用相同的門檻" },
    ],
    answer: "A",
    explanation:
    ...
    choiceExplanations: {
      B: "Z-score的定義即為讀數與平均值的差距、除以標準差，必須計算平均值與標準差，並非僅比較讀數與中位數的差距。",
      C: "Z-score方法假設資料接近常態分布時效果較佳，此情境振動讀數近似常態分布，正是適用的典型情境，並非只適用於右偏分布資料。",
      D: "Z-score的判定門檻可依資料特性與應用需求調整，3只是常見的參考值之一，並非所有資料集與情境都必須採用固定門檻。",
    },
    topic: "L11202 資料整理與分析流程",
    difficulty: "中",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "正規化與標準化是同一種方法的不同名稱，兩者的計算公式與結果相同" },
      { id: "B", text: "正規化通常縮放數值到固定區間，標準化則轉換為平均值0、標準差1分布" },
      { id: "C", text: "正規化是將資料轉換為平均值為0、標準差為1的分布，與資料的最大最小值無關" },
      { id: "D", text: "只要資料筆數夠多，就不需要進行正規化或標準化，模型仍能公平看待兩項特徵" },
    ],
    answer: "B",
    explanation:
    ...
    choiceExplanations: {
      A: "正規化依最大最小值做線性縮放，標準化依平均值與標準差做分布轉換，兩者的計算公式與適用情境並不相同，並非同一方法的不同名稱。",
      C: "「轉換為平均值0、標準差1」描述的是標準化，而非正規化；正規化的核心是依最大最小值將數值縮放到固定區間。",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "Label Encoding最適合此欄位，因為它會將三種還款方式分別轉為0、1、2等有大小關係的數字" },
      { id: "B", text: "One-hot與Label Encoding對此欄位的編碼結果相同，選用哪一種都不影響模型判讀" },
      { id: "C", text: "這個欄位不需要任何編碼轉換，模型能直接讀懂文字類別內容並正確判斷彼此關係" },
      { id: "D", text: "One-hot較適合此欄位，因為類別間無順序關係，可避免模型誤判類別間存在大小順序" },
    ],
    answer: "D",
    explanation:
    ...
    choiceExplanations: {
      A: "Label Encoding會賦予類別0、1、2等具大小關係的數字，用於「還款方式」這種無順序關係的類別，反而容易讓模型誤判類別間存在不存在的大小順序，並非最適合的選擇。",
      B: "兩種編碼方式的結果並不相同——One-hot產生多個二元欄位、不隱含順序，Label Encoding產生單一數值欄位、隱含順序，選用哪一種會實質影響模型是否誤判類別間的關係。",
      C: "多數機器學習模型仍需要數值化的輸入，無法直接處理原始文字類別，仍須經過編碼轉換才能輸入模型。",
    },
    topic: "L11202 資料整理與分析流程",
    difficulty: "難",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "對數轉換能壓縮數值範圍、緩解右偏分布長尾，使資料分布較接近常態" },
      { id: "B", text: "對數轉換的效果與正規化相同，兩者都是把數值縮放到0至1的固定區間" },
      { id: "C", text: "對數轉換只適用於資料呈左偏分布的情境，右偏分布的資料不適合採用" },
      { id: "D", text: "對數轉換後的數值會失去原始資料的大小順序，因此不適合用於後續分析" },
    ],
    answer: "A",
    explanation:
    ...
    choiceExplanations: {
      B: "對數轉換是以取對數的方式壓縮數值範圍、緩解長尾，正規化則是依最大最小值線性縮放到固定區間，兩者計算方式與效果並不相同。",
      C: "對數轉換對於右偏分布（多數集中低值、少數極大值造成長尾）特別有效，此情境的故障間隔時間資料正屬於右偏分布，並非只適用於左偏分布。",
      D: "對數轉換屬於單調遞增函數，數值大小的相對順序在轉換前後保持一致，不會因此喪失原始資料的大小順序。",
    },
    topic: "L11202 資料整理與分析流程",
    difficulty: "中",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "兩個階段都屬於CDA（驗證式資料分析），差異只在於使用的圖表種類不同" },
      { id: "B", text: "自由觀察階段屬於EDA（探索式），假設檢定階段則屬於CDA（驗證式）" },
      { id: "C", text: "兩個階段都屬於EDA（探索式資料分析），因為兩者都涉及資料視覺化的操作" },
      { id: "D", text: "先進行的自由觀察階段才屬於CDA分析，後續假設檢定階段則屬於EDA分析" },
    ],
    answer: "B",
    explanation:
    ...
    choiceExplanations: {
      A: "兩階段的差異核心在於是否已有明確待驗證的假設，而非圖表種類——自由觀察未預設假設屬EDA，針對假設做統計檢定才屬CDA。",
      C: "EDA同樣可能使用視覺化工具，但關鍵在於「探索」而非「驗證」；即使兩階段都涉及圖表或視覺化操作，只要尚未預設假設即屬EDA，並非兩者都算EDA。",
      D: "對應恰好顛倒——自由觀察、尚未預設假設的階段屬於EDA，針對明確假設進行統計檢定的階段才屬於CDA。",
    },
    topic: "L11202 資料整理與分析流程",
    difficulty: "中",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "C", text: "這種分布稱為右偏分布，但少數極端高值對平均數幾乎不會造成任何影響" },
    ...
    choiceExplanations: {
      ...
      C: "少數極端高值正是導致平均數被向右拉高、高於中位數的主因，對平均數的影響顯著，並非「幾乎不會造成任何影響」。",
    },
    topic: "L11202 資料整理與分析流程",
    difficulty: "難",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "散佈圖，將練習時數與測驗分數分別作為兩軸座標，觀察點的分布趨勢" },
      { id: "B", text: "直方圖，因為這種圖表最適合同時呈現兩個連續變數之間的關聯趨勢" },
      { id: "C", text: "箱型圖，因為它的主要用途是比較兩個連續變數之間是否存在線性關聯" },
      { id: "D", text: "圖表種類的選用與變數型態或分析目的無關，任意選用皆能達成相同效果" },
    ],
    answer: "A",
    explanation:
    ...
    choiceExplanations: {
      ...
      C: "箱型圖的主要用途是呈現單一變數的中位數、四分位距與離群值，或比較不同類別間的分布差異，並非用於檢視兩個連續變數之間的線性關聯。",
      D: "不同圖表對應不同的變數型態與分析目的，選用是否恰當會直接影響能否正確呈現資料關係，並非任意選用都能達成相同效果。",
    },
    topic: "L11202 資料整理與分析流程",
    difficulty: "中",
    source: "generated",
  ...
  // ── L11203 資料隱私與安全（11 題）────────────────────────────────
  {
    ...
    choices: [
      { id: "A", text: "這種處理方式稱為匿名化，因為病歷資料中已不含病患姓名等直接識別資訊" },
      { id: "B", text: "這種處理方式與刪除病患所有身分資訊的作法並無差異，效果相同" },
      { id: "C", text: "這種處理方式稱為假名化，因保留可復原身分的對照表，屬於可逆處理" },
      { id: "D", text: "只要保留對照表，這批資料就不受個人資料保護相關規範的規範" },
    ],
    answer: "C",
    explanation:
      "假名化（Pseudonymization）指以代碼取代直接識別資訊，但另外保存對照表，日後仍可透過對照表復原真實身分，屬於「可逆」的處理方式；匿名化（Anonymization）則是徹底移除或轉換到無法（或極難）復原真實身分的程度，屬於「不可逆」處理。此醫院的作法保留了可復原身分的對照表，屬於假名化而非匿名化，也因為資料仍可復原識別，通常仍受個人資料保護規範的規範，並非等同於完全刪除身分資訊。",
    choiceExplanations: {
      A: "匿名化要求資料在事實上無法（或極難）復原真實身分，此情境保留了可復原身分的對照表，屬於可逆的假名化，而非匿名化。",
      B: "假名化仍保留對照表以供日後復原身分，與完全刪除所有身分資訊（不可復原）的效果並不相同，兩者的隱私保護程度有實質差異。",
      D: "假名化後的資料仍可透過對照表復原為可識別的個人資料，通常仍屬於個人資料保護規範所稱的個人資料，並非完全不受規範。",
    },
  ...
  },
  {
    ...
    subjectId: "junior-ai-basics",
    prompt:
      "某銀行將客戶交易資料用於內部風險模型開發，資料團隊主張「只要移除客戶姓名、身分證字號等欄位，資料就已經達到匿名化，即使搭配保留的帳戶代碼對照表也不影響判定」，法遵人員認為此說法有誤。下列說明何者最正確？",
    choices: [
      { id: "A", text: "移除姓名與身分證字號等欄位後，不論是否保留對照表，就視為匿名化" },
      { id: "B", text: "只要保留可復原身分的對照表，移除姓名欄位仍屬假名化而非匿名化" },
      { id: "C", text: "匿名化與假名化在個人資料保護規範下受到相同的規範，兩者無須區分" },
      { id: "D", text: "只要資料經過任何形式的代碼化處理，就視為已達到匿名化的程度" },
    ],
    answer: "B",
    explanation:
      "判斷是否達到匿名化的關鍵，不在於是否移除了姓名、身分證字號等直接識別欄位，而在於是否仍存在（即使由他方保管）可用以復原真實身分的途徑。此情境雖移除姓名等欄位，但仍保留帳戶代碼與客戶身分的對照表，代表資料仍可被復原識別，屬於假名化而非匿名化；匿名化與假名化因可逆性不同，在個人資料保護規範下的定位也有差異，並非移除欄位或經任何代碼化處理就一律等同匿名化。",
    choiceExplanations: {
      A: "是否保留可復原身分的對照表，正是區分假名化與匿名化的關鍵依據，並非移除姓名等欄位後就不論是否保留對照表，一律視為匿名化。",
      C: "假名化資料因仍可復原識別，通常仍受個人資料保護規範規範；匿名化資料若確實無法復原識別，規範上的定位有所不同，兩者並非完全相同、無須區分。",
      D: "代碼化只是處理手法之一，若代碼與身分的對照表仍被保留、可供復原，資料仍屬假名化，並非只要經過代碼化處理就自動達到匿名化的程度。",
    },
    topic: "L11203 資料隱私與安全",
    difficulty: "難",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "B", text: "只要資料是醫院合法蒐集取得，日後即可不受目的限制、自由用於任何用途" },
      { id: "C", text: "目的限制原則只適用於政府機關蒐集的個人資料，民間醫院的病患資料不受此原則規範" },
      { id: "D", text: "病患聯絡資料是否能用於行銷用途，取決於醫院內部行政程序是否核准，與病患同意與否無關" },
    ],
    answer: "A",
    explanation:
    ...
    choiceExplanations: {
      B: "合法蒐集只代表取得資料的過程符合規範，日後利用仍須限於原蒐集目的範圍內，逾越目的的利用仍受規範，並非可自由用於任何用途。",
      C: "目的限制原則同樣適用於民間機構（含醫院）蒐集的個人資料，並非僅限於政府機關蒐集的資料。",
      D: "逾越原蒐集目的的利用，通常須另行取得當事人同意或符合法定要件，並非僅憑醫院內部行政程序核准即可決定，仍須考量病患本人的同意。",
    },
    topic: "L11203 資料隱私與安全",
    difficulty: "中",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "個人資料保護規範只保障當事人查詢資料的權利，並未賦予當事人要求更正資料的權利" },
      { id: "B", text: "銀行對客戶提出的查詢或更正請求，可依內部系統技術限制為由拒絕受理" },
      { id: "C", text: "當事人的查詢與更正權利，只適用於政府機關保有的個人資料，民間銀行不適用" },
      { id: "D", text: "個人資料保護規範通常賦予當事人查詢、更正等權利，銀行應提供適當管道受理請求" },
    ],
    answer: "D",
    explanation:
    ...
    choiceExplanations: {
      A: "個人資料保護規範通常同時賦予當事人查詢與更正等權利，並非僅保障查詢、不含更正資料的權利。",
      B: "內部系統技術限制不能作為拒絕受理當事人合法查詢或更正請求的理由，機構原則上應調整流程或系統以配合受理，而非一律拒絕。",
      C: "當事人的查詢與更正權利同樣適用於民間機構保有的個人資料，並非僅限於政府機關保有的個人資料。",
    },
    topic: "L11203 資料隱私與安全",
    difficulty: "中",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "B", text: "差分隱私是在統計查詢結果中加入經校準的隨機雜訊，使個別資料難以被推論存在" },
      { id: "C", text: "差分隱私只適用於保護實體檔案的傳輸安全，與統計查詢結果是否洩漏個人資訊無關" },
      { id: "D", text: "只要查詢介面只回傳統計數字、不回傳個別病歷，就不會洩漏個人資訊，無須額外機制" },
    ],
    answer: "B",
    explanation:
    ...
    choiceExplanations: {
      ...
      C: "差分隱私要處理的正是傳輸安全以外的問題——資料使用階段查詢結果可能造成的推論風險，與傳輸過程的加密防護是不同的保護面向。",
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "B", text: "只要採用傳輸加密，攻擊者即使攔截封包，仍可直接讀取其中的帳號密碼內容" },
      { id: "C", text: "傳輸加密能防止資料在傳輸過程中被攔截後直接讀取內容，是防範竊聽的重要機制" },
      { id: "D", text: "傳輸加密只能防止資料在傳輸過程中遭竄改，無法防止資料內容被直接讀取" },
    ],
    answer: "C",
    explanation:
    ...
    choiceExplanations: {
      ...
      B: "傳輸加密的目的正是使攔截封包的攻擊者難以直接讀取其中內容，若攔截後仍可直接讀取明文，代表加密機制本身失效，並非傳輸加密正常運作下的結果。",
      D: "傳輸加密除了能降低資料遭竄改後不被察覺的風險，也能防止封包內容被直接讀取，並非僅具備防竄改功能而完全無法保護內容不被讀取。",
    },
    topic: "L11203 資料隱私與安全",
    difficulty: "中",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "這種攻擊稱為中間人攻擊，確實驗證憑證是防範此類攻擊的重要措施之一" },
      { id: "B", text: "這種攻擊稱為差分隱私攻擊，防範方式是在傳輸資料中加入隨機雜訊" },
      { id: "C", text: "只要診療資料本身有加密，無論是否驗證憑證，都能避免這種攻擊發生" },
      { id: "D", text: "這種攻擊屬於資料庫層級的存取控制問題，與連線建立時的憑證驗證程序無關" },
    ],
    answer: "A",
    explanation:
    ...
    choiceExplanations: {
      B: "差分隱私是在統計查詢結果中加入雜訊以保護個體隱私，與防範攻擊者偽裝身分介入通訊連線的中間人攻擊是不同的概念與防範手段。",
      C: "若未確實驗證憑證，攻擊者仍可能偽裝成合法一方介入連線本身，即使資料本身有加密，也無法完全排除攻擊者冒充身分的風險，驗證憑證仍是必要措施。",
      D: "中間人攻擊發生在通訊雙方建立連線與傳輸資料的過程，防範重點在於連線建立時的憑證驗證，而非資料庫層級的存取控制。",
    },
    topic: "L11203 資料隱私與安全",
    difficulty: "難",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "只要系統設有完整的操作日誌紀錄，權限範圍設定得多寬鬆都不會產生資安疑慮" },
      { id: "B", text: "系統管理員基於職務需要，理應擁有系統中所有功能的最高操作權限，不應設限" },
      { id: "C", text: "存取控制的目的只在於管理系統效能與運作穩定，與資料外洩風險的防範無關" },
    ...
    choiceExplanations: {
      ...
      B: "是否擁有高權限應依職務實際需要判定，而非以「基於職務需要」為由賦予所有功能的最高權限；僅需檢視餘額的職務並不需要修改密碼或匯出全部資料的權限。",
      C: "存取控制的目的正包含降低資料被未經授權存取或外洩的風險，與系統效能或運作穩定是不同的考量面向，並非與資料外洩風險無關。",
    },
    topic: "L11203 資料隱私與安全",
    difficulty: "中",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "聯邦學習的作法是先將各院病歷資料加密後，統一傳輸集中到單一伺服器再訓練模型" },
      { id: "B", text: "聯邦學習讓各院在本地訓練模型，只交換模型參數更新，資料不須離開院內" },
      { id: "C", text: "聯邦學習與同態加密指的是同一種技術，兩者的運作方式與適用情境相同" },
      { id: "D", text: "導入聯邦學習後，各院病歷資料仍需要實際離開院內系統，才能完成模型的協作訓練" },
    ],
    answer: "B",
    explanation:
    ...
    choiceExplanations: {
      A: "聯邦學習的核心正是避免將原始病歷資料集中傳輸，即使資料經過加密，集中傳輸仍不符合聯邦學習「資料留在本地、只交換模型更新」的運作方式。",
      C: "聯邦學習與同態加密是兩種不同的隱私保護技術，聯邦學習著重於分散式本地訓練並交換模型更新，同態加密著重於在加密狀態下直接進行運算，兩者運作方式與適用情境並不相同。",
      D: "聯邦學習的設計目的正是讓資料留在院內、不須離開本地系統，僅交換模型參數更新，並非仍需要資料實際離開院內系統才能協作訓練。",
    },
    topic: "L11203 資料隱私與安全",
    difficulty: "難",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "同態加密的運作方式，是先將資料解密為明文後，再交由雲端服務商進行運算" },
      { id: "B", text: "採用同態加密後，雲端服務商在運算過程中會需要客戶資料的明文與加密金鑰" },
      { id: "C", text: "同態加密讓雲端服務商在加密狀態下直接運算，無須取得明文內容" },
      { id: "D", text: "同態加密與聯邦學習指的是同一種技術，可以在此情境中交替使用而不影響結果" },
    ],
    answer: "C",
    explanation:
      "同態加密（Homomorphic Encryption）允許在資料維持加密狀態下直接進行運算，運算結果解密後與對明文運算的結果一致，因此雲端服務商在整個運算過程中無須取得客戶資料的明文內容或解密金鑰，適合此情境「委外運算但不希望對方看到明文」的需求；這與聯邦學習（讓資料留在本地訓練、交換模型更新）是不同的技術與適用情境，並非同一種技術可交替使用。",
    choiceExplanations: {
      A: "同態加密的核心正是讓資料「不需解密」也能直接運算，若先解密為明文才運算，雲端服務商便能看到明文內容，違背此情境「不希望對方看到明文」的需求，也不符合同態加密的定義。",
      B: "同態加密運算全程只需加密後的資料，雲端服務商不需要、也不應取得明文或解密金鑰，否則便失去採用同態加密保護資料的意義。",
      D: "同態加密著重於在加密狀態下直接運算，聯邦學習著重於資料留在本地訓練、只交換模型更新，兩者技術原理與適用情境不同，並非同一種技術。",
    },
    topic: "L11203 資料隱私與安全",
    difficulty: "難",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "B", text: "模型只要通過標準的準確率測試，就代表訓練資料不存在被逐字記憶並外洩的風險" },
      { id: "C", text: "這種現象屬於中間人攻擊的一種型態，防範方式是加強連線時的憑證驗證程序" },
      { id: "D", text: "模型可能在訓練時記憶樣本內容，被提示誘發逐字重現，屬於訓練資料記憶洩漏" },
    ],
    answer: "D",
    explanation:
    ...
    choiceExplanations: {
      ...
      B: "標準準確率測試評估的是模型整體預測表現，無法檢測出模型是否對特定訓練樣本產生逐字記憶，通過準確率測試不代表不存在訓練資料記憶外洩的風險。",
      C: "中間人攻擊發生在通訊雙方傳輸資料的連線過程，此現象則是模型本身在推論階段重現訓練資料內容，成因與防範方向皆與連線憑證驗證無關。",
    },
    topic: "L11203 資料隱私與安全",
    difficulty: "難",
    source: "generated",
