...
export const practiceQuestions: Question[] = [
  ...
  // ── L11201 資料基本概念與來源（11 題）────────────────────────────
  {
    ...
    choices: [
      { id: "A", text: "這類資料屬於半結構化資料，因為關聯式資料庫本身即為半結構化的儲存形式" },
      { id: "B", text: "這類資料因儲存於資料庫中，本質上屬於非結構化資料，需先經過欄位解析才能使用" },
      { id: "C", text: "資料的欄位是否固定，只會影響儲存所需的硬碟空間大小，與資料型態判別無關" },
      { id: "D", text: "這類資料的欄位型態事先定義完成，屬於結構化資料，適合以資料表儲存" },
    ],
    answer: "D",
    explanation:
      "結構化資料具有事先定義好的欄位與型態，能整齊地存放在關聯式資料庫的資料表中，此銀行交易紀錄正符合此特徵，屬於結構化資料；非結構化資料指無固定格式者（如文字、影像），半結構化資料則介於兩者之間（如JSON、XML），皆與此情境不符。",
    choiceExplanations: {
      A: "半結構化資料指沒有固定欄位、但仍帶有標籤或層級（如JSON、XML）的資料，關聯式資料庫的固定欄位資料表屬於結構化資料，並非半結構化。",
      B: "資料存放於資料庫中且具有固定欄位定義，正是結構化資料的典型特徵，並非非結構化資料。",
      C: "是否具有事先定義的固定欄位與型態，正是判別結構化與否的核心依據，並非無關。",
    },
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "B", text: "因為每筆紀錄都有時間戳記與設備代號欄位，這類資料應歸類為結構化資料" },
      { id: "C", text: "這類資料帶有標籤但欄位不固定，屬於半結構化資料，格式如JSON、XML" },
    ...
    choiceExplanations: {
      ...
      B: "結構化資料要求所有紀錄的欄位型態與數量完全一致，此處不同設備附加欄位並不相同，不符合完全結構化的定義。",
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "C", text: "影像資料因檔案較大，判別型態的依據是檔案大小而非有無固定欄位結構" },
      { id: "D", text: "影像檔案帶有拍攝時間與地點的中繼資料，因此應歸類為結構化資料" },
    ],
    answer: "B",
    explanation:
    ...
    choiceExplanations: {
      ...
      C: "判別結構化與否的依據是資料有無固定欄位與格式規則，與檔案大小無關，即使是小檔案的自由格式文字仍屬非結構化資料。",
      D: "少量中繼資料（如拍攝時間）不能使整份影像檔案轉為結構化資料，判別依據是影像內容本身是否具有固定欄位結構，而非有無附帶中繼資料。",
    },
    topic: "L11201 資料基本概念與來源",
    difficulty: "易",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "這項特徵屬於Variety（多樣性），因為感測器數量多、資料種類自然增加" },
      { id: "B", text: "這項特徵屬於Volume（數量），指資料規模龐大到超出傳統處理方式負荷" },
      { id: "C", text: "這項特徵屬於Value（價值），因為資料量越大代表能萃取出的商業價值越高" },
      { id: "D", text: "這項特徵屬於Veracity（真實性），因為資料量龐大代表其可信度較高" },
    ],
    answer: "B",
    explanation:
    ...
    choiceExplanations: {
      A: "Variety（多樣性）指資料型態與來源的種類多寡，此情境描述的是「量測數據總量龐大」，是規模問題而非種類問題，屬於Volume而非Variety。",
      C: "Value（價值）指從資料中萃取出的商業效益，資料量龐大只是原始素材多，未必等於能萃取的價值也隨之提高，兩者屬不同構面。",
      D: "Veracity（真實性）指資料是否可信、有無雜訊或誤差，與資料量的大小是兩個不同構面，資料量大不代表可信度較高。",
    },
    topic: "L11201 資料基本概念與來源",
    difficulty: "中",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "B", text: "這項特徵屬於Volume（數量），因為每毫秒產生資料，代表資料總量會是五者中最龐大的" },
      { id: "C", text: "這項特徵屬於Variety（多樣性），因為報價與成交紀錄是兩種不同型態的資料" },
    ...
    choiceExplanations: {
      B: "資料產生速度快不代表資料總量（Volume）必然是五者中最龐大的，速度與數量是不同構面，須分別評估。",
      C: "Variety（多樣性）指資料型態與來源的種類多寡，報價與成交紀錄同屬數值型的交易資料，型態相近，此情境描述的重點是處理速度極快，屬於Velocity而非Variety。",
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "B", text: "這種特徵屬於Variety（多樣性），指資料型態與來源多元，涵蓋數值與影像格式" },
      { id: "C", text: "這種特徵屬於Veracity（真實性），因為來源種類多，資料的可信程度會隨之提高" },
      { id: "D", text: "這種特徵屬於Volume（數量），來源種類的多寡決定了資料總量是否達到大數據等級" },
    ],
    answer: "B",
    explanation:
    ...
    choiceExplanations: {
      ...
      C: "Veracity（真實性）指資料本身有無雜訊或誤差，來源種類多寡與資料可信度高低並無必然關聯，農民手寫筆記反而可能主觀誤差較大。",
      D: "來源種類多不會自動使資料總量達到大數據規模，資料量大小仍取決於實際蒐集的筆數與頻率，兩者是不同構面。",
    },
    topic: "L11201 資料基本概念與來源",
    difficulty: "中",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "這項問題屬於Veracity（真實性），指資料可信程度，需清洗才能提升品質" },
      { id: "B", text: "這項問題屬於Velocity（速度），因為雜訊讀數通常會拖慢整體資料傳輸的速度" },
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "這種現象屬於Volume（數量），持續蒐集更多點擊紀錄會提高可用資訊的比例" },
      { id: "B", text: "這種現象屬於Variety（多樣性），因為點擊紀錄的欄位種類繁多，代表資料本身價值已經很高" },
      { id: "C", text: "這種現象屬於Value（價值），指資料量大不等於價值高，需經萃取才能取得具分析意義的資訊" },
    ...
    choiceExplanations: {
      ...
      B: "欄位種類繁多屬於Variety（多樣性）的範疇，種類多寡與資料本身的分析價值高低並無必然關聯，多數欄位可能仍無助於預測目標。",
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "B", text: "灌溉裝置回傳的用水量紀錄屬於自有產品資料，行情頁面則屬於網路爬蟲資料" },
      { id: "C", text: "灌溉裝置回傳的用水量紀錄屬於網路爬蟲資料，行情頁面內容屬於自有產品資料" },
      { id: "D", text: "兩批資料都應歸類為網路爬蟲資料，因為兩者最終都是透過網路傳輸取得的" },
    ],
    answer: "B",
    explanation:
    ...
    choiceExplanations: {
      ...
      D: "灌溉裝置的用水量紀錄是自家產品運作過程中直接產生、回傳給公司的資料，屬於自有產品資料，並非透過程式擷取他人網站取得的爬蟲資料。",
    },
    topic: "L11201 資料基本概念與來源",
    difficulty: "中",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "D", text: "第一批屬於感測器網路資料、第二批屬於公開API、第三批屬於外部購買資料" },
    ],
    answer: "D",
    explanation:
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "B", text: "資料整合的目的是打破系統孤島、建立一致的客戶視圖，統一保存期限並非其核心目的" },
      { id: "C", text: "資料整合的目的與資料保存期限彼此無關，兩者在資料治理上不應同時規劃或討論" },
      { id: "D", text: "資料整合是把各系統資料集中儲存在同一個檔案的動作，不包含格式、定義或欄位的一致化" },
    ],
    answer: "B",
    explanation:
    ...
    choiceExplanations: {
      ...
      C: "保存期限與資料整合雖非同一件事，但兩者在資料治理架構下仍可能相關聯（例如整合後仍須遵循各類資料的留存規範），並非完全無關、不可同時討論。",
  ...
  },
  {
    ...
    choiceExplanations: {
      B: "Z-score的判定門檻是依資料特性與應用需求選定的參考值（如絕對值超過3），並沒有「樣本數越多門檻應設得越高」這種隨樣本規模調整的通則。",
  ...
  // ── L11203 資料隱私與安全（11 題）────────────────────────────────
  {
    ...
    choices: [
      { id: "A", text: "這種處理方式稱為假名化，因保留可復原身分的對照表，屬於可逆處理" },
      { id: "B", text: "這種處理方式與刪除病患所有身分資訊的作法並無差異，效果相同" },
      { id: "C", text: "保留對照表這件事，會使這批資料不受個人資料保護相關規範的拘束" },
    ...
    choiceExplanations: {
      ...
      C: "假名化後的資料仍可透過對照表復原為可識別的個人資料，通常仍屬於個人資料保護規範所稱的個人資料，並非完全不受規範。",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "準識別欄位組合若夠獨特，可能與外部資料連結而重新識別，k-匿名即為降低此風險而設計" },
      { id: "B", text: "重新識別的風險只在保留姓名或身分證字號時才存在，移除兩項欄位便等同於嚴謹的匿名化處理" },
      { id: "C", text: "移除姓名與身分證字號後，出生年月、郵遞區號與性別等其餘欄位已不再具備重新識別個人的風險" },
    ...
    choiceExplanations: {
      B: "即使未保留姓名或身分證字號，準識別欄位組合仍可能構成連結攻擊的風險，移除這兩項欄位不足以等同於嚴謹的匿名化處理。",
      C: "出生年月、郵遞區號、性別等準識別欄位的特定組合仍可能在資料集中相當獨特，並非移除姓名與身分證字號後就不再具備重新識別的風險。",
  ...
  },
  {
    ...
    choiceExplanations: {
      A: "合法蒐集只代表取得資料的過程符合規範，日後利用仍須限於原蒐集目的範圍內，逾越目的的利用仍受規範，並非可自由用於任何用途。",
  ...
  },
  {
    ...
    choiceExplanations: {
      A: "當事人的查詢與更正權利同樣適用於民間機構保有的個人資料，並非僅限於政府機關保有的個人資料。",
      B: "個人資料保護規範通常同時賦予當事人查詢與更正等權利，並非僅保障查詢、不含更正資料的權利。",
      D: "內部系統技術限制不能作為拒絕受理當事人合法查詢或更正請求的理由，機構原則上應調整流程或系統以配合受理，而非一律拒絕。",
    },
    topic: "L11203 資料隱私與安全",
    difficulty: "中",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "差分隱私是在統計查詢結果中加入經校準的隨機雜訊，使個別資料難以被推論存在" },
      { id: "B", text: "查詢介面設計為回傳統計數字、不回傳個別病歷，如此即不會洩漏個人資訊，無須額外機制" },
      { id: "C", text: "差分隱私的作法是先將所有病患姓名以代碼取代，再開放外部研究者直接查詢原始病歷" },
      { id: "D", text: "差分隱私是用來保護實體檔案傳輸安全的技術，與統計查詢結果是否洩漏個人資訊是兩回事" },
    ],
    answer: "A",
    explanation:
    ...
    choiceExplanations: {
      B: "即使查詢介面只回傳彙整統計數字，攻擊者仍可能透過反覆查詢比對推論出特定個人的資料是否存在，這正是差分隱私要防範的風險，並非「必然不會洩漏」。",
      C: "以代碼取代姓名屬於假名化處理，而差分隱私的核心是在統計查詢結果中加入隨機雜訊，兩者是不同的技術手段，且差分隱私的重點並非開放查詢原始病歷。",
      D: "差分隱私要處理的正是傳輸安全以外的問題——資料使用階段查詢結果可能造成的推論風險，與傳輸過程的加密防護是不同的保護面向。",
    },
    topic: "L11203 資料隱私與安全",
    difficulty: "難",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "傳輸加密防止的是資料在傳輸過程中遭竄改，資料內容被直接讀取的風險不在其防護範圍" },
      { id: "B", text: "採用傳輸加密後，攻擊者攔截封包時仍可直接讀取其中的帳號密碼內容" },
      { id: "C", text: "傳輸加密的主要作用是防止資料庫遭到未經授權的內部人員存取，與網路傳輸過程無關" },
      { id: "D", text: "傳輸加密能防止資料在傳輸過程中被攔截後直接讀取內容，是防範竊聽的重要機制" },
    ],
    answer: "D",
    explanation:
    ...
    choiceExplanations: {
      A: "傳輸加密除了能降低資料遭竄改後不被察覺的風險，也能防止封包內容被直接讀取，並非僅具備防竄改功能而完全無法保護內容不被讀取。",
      B: "傳輸加密的目的正是使攔截封包的攻擊者難以直接讀取其中內容，若攔截後仍可直接讀取明文，代表加密機制本身失效，並非傳輸加密正常運作下的結果。",
      C: "傳輸加密保護的是資料在網路上傳輸過程中的安全，防止的是外部攔截竊聽的風險，內部人員對資料庫的存取則須另由存取控制與稽核機制管理，兩者是不同的防護面向。",
    },
    topic: "L11203 資料隱私與安全",
    difficulty: "中",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "診療資料本身有加密這件事，已經足以避免這種攻擊發生，無須另外驗證憑證" },
      { id: "B", text: "這種攻擊屬於資料庫層級的存取控制問題，與連線建立時的憑證驗證程序無關" },
      { id: "C", text: "這種攻擊稱為中間人攻擊，確實驗證憑證是防範此類攻擊的重要措施之一" },
      { id: "D", text: "這種攻擊稱為差分隱私攻擊，防範方式是在傳輸資料中加入隨機雜訊" },
    ],
    answer: "C",
    explanation:
    ...
    choiceExplanations: {
      A: "若未確實驗證憑證，攻擊者仍可能偽裝成合法一方介入連線本身，即使資料本身有加密，也無法完全排除攻擊者冒充身分的風險，驗證憑證仍是必要措施。",
      B: "中間人攻擊發生在通訊雙方建立連線與傳輸資料的過程，防範重點在於連線建立時的憑證驗證，而非資料庫層級的存取控制。",
      D: "差分隱私是在統計查詢結果中加入雜訊以保護個體隱私，與防範攻擊者偽裝身分介入通訊連線的中間人攻擊是不同的概念與防範手段。",
    },
    topic: "L11203 資料隱私與安全",
    difficulty: "難",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "應依最小權限原則，只授予職務所需的最低權限，並搭配稽核監控異常存取" },
      { id: "B", text: "系統設有完整的操作日誌紀錄，因此權限範圍設定得寬鬆一些不會產生資安疑慮" },
      { id: "C", text: "系統管理員基於職務需要，理應擁有系統中所有功能的最高操作權限，不應設限" },
      { id: "D", text: "存取控制的目的只在於管理系統效能與運作穩定，與資料外洩風險的防範無關" },
    ],
    answer: "A",
    explanation:
    ...
    choiceExplanations: {
      B: "操作日誌有助於事後追蹤異常行為，但無法取代事前限制權限範圍的必要性，權限設定過寬仍會增加資料遭誤用或外洩的風險，並非有日誌就不會產生疑慮。",
      C: "是否擁有高權限應依職務實際需要判定，而非以「基於職務需要」為由賦予所有功能的最高權限；僅需檢視餘額的職務並不需要修改密碼或匯出全部資料的權限。",
      D: "存取控制的目的正包含降低資料被未經授權存取或外洩的風險，與系統效能或運作穩定是不同的考量面向，並非與資料外洩風險無關。",
    },
    topic: "L11203 資料隱私與安全",
    difficulty: "中",
    source: "generated",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "導入聯邦學習後，各院病歷資料仍需要實際離開院內系統，才能完成模型的協作訓練" },
      { id: "B", text: "聯邦學習的作法是先將各院病歷資料加密後，統一傳輸集中到單一伺服器再訓練模型" },
      { id: "C", text: "聯邦學習與同態加密指的是同一種技術，兩者的運作方式與適用情境相同" },
      { id: "D", text: "聯邦學習讓各院在本地訓練模型，只交換模型參數更新，資料不須離開院內" },
    ],
    answer: "D",
    explanation:
    ...
    choiceExplanations: {
      A: "聯邦學習的設計目的正是讓資料留在院內、不須離開本地系統，僅交換模型參數更新，並非仍需要資料實際離開院內系統才能協作訓練。",
      B: "聯邦學習的核心正是避免將原始病歷資料集中傳輸，即使資料經過加密，集中傳輸仍不符合聯邦學習「資料留在本地、只交換模型更新」的運作方式。",
  ...
  },
  {
    ...
    choices: [
      { id: "A", text: "同態加密的運算速度通常比明文運算更快，適合大規模即時運算場景" },
    ...
    choiceExplanations: {
      A: "同態加密因需在加密狀態下執行運算，計算成本遠高於明文運算、速度通常慢上許多，並非比明文運算更快，也不特別適合大規模即時運算場景。",
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "B", text: "模型通過標準的準確率測試，即代表訓練資料不存在被逐字記憶並外洩的風險" },
