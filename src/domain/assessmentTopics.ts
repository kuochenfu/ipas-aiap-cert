...
export const practiceTopics: Record<string, AssessmentTopic[]> = {
  "junior-ai-basics": [
    { code: "L11101", name: "AI 的定義與分類", count: 16 },
    { code: "L11102", name: "AI 治理概念", count: 16 },
    { code: "L11201", name: "資料基本概念與來源", count: 16 },
    { code: "L11202", name: "資料整理與分析流程", count: 16 },
    { code: "L11203", name: "資料隱私與安全", count: 16 },
    { code: "L11301", name: "機器學習基本原理", count: 16 },
    { code: "L11302", name: "常見的機器學習模型", count: 17 },
    { code: "L11401", name: "鑑別式 AI 與生成式 AI 的基本原理", count: 16 },
    { code: "L11402", name: "鑑別式 AI 與生成式 AI 的整合應用", count: 16 },
  ],
  "junior-genai": [
    { code: "L12101", name: "No Code / Low Code 的基本概念", count: 17 },
    { code: "L12102", name: "No Code / Low Code 的優勢與限制", count: 17 },
    { code: "L12201", name: "生成式 AI 應用領域與常見工具", count: 18 },
    { code: "L12202", name: "如何善用生成式 AI 工具", count: 18 },
    { code: "L12301", name: "生成式 AI 導入評估", count: 17 },
    { code: "L12302", name: "生成式 AI 導入規劃", count: 17 },
    { code: "L12303", name: "生成式 AI 風險管理", count: 16 },
  ],
  "senior-ai-tech": [
    { code: "L21101", name: "自然語言處理技術與應用", count: 16 },
    { code: "L21102", name: "電腦視覺技術與應用", count: 16 },
    { code: "L21103", name: "生成式 AI 技術與應用", count: 16 },
    { code: "L21104", name: "多模態人工智慧應用", count: 16 },
    { code: "L21201", name: "AI 導入評估", count: 16 },
    { code: "L21202", name: "AI 導入規劃", count: 16 },
    { code: "L21203", name: "AI 風險管理", count: 15 },
    { code: "L21301", name: "數據準備與模型選擇", count: 15 },
    { code: "L21302", name: "AI 技術系統集成與部署", count: 16 },
  ],
  "senior-bigdata": [
    { code: "L22101", name: "敘述性統計與資料摘要技術", count: 14 },
    { code: "L22102", name: "機率分佈與資料分佈模型", count: 13 },
    { code: "L22103", name: "假設檢定與統計推論", count: 13 },
    { code: "L22201", name: "數據收集與清理", count: 13 },
    { code: "L22202", name: "數據儲存與管理", count: 13 },
    { code: "L22203", name: "數據處理技術與工具", count: 13 },
    { code: "L22301", name: "統計學在大數據中的應用", count: 12 },
    { code: "L22302", name: "常見的大數據分析方法", count: 13 },
    { code: "L22303", name: "數據可視化工具", count: 12 },
    { code: "L22401", name: "大數據與機器學習", count: 13 },
    { code: "L22402", name: "大數據在鑑別式 AI 中的應用", count: 13 },
    { code: "L22403", name: "大數據在生成式 AI 中的應用", count: 12 },
    { code: "L22404", name: "大數據隱私保護、安全與合規", count: 12 },
  ],
  "senior-ml": [
    { code: "L23101", name: "機率／統計之機器學習基礎應用", count: 13 },
    { code: "L23102", name: "線性代數之機器學習基礎應用", count: 13 },
    { code: "L23103", name: "數值優化技術與方法", count: 12 },
    { code: "L23201", name: "機器學習原理與技術", count: 12 },
    { code: "L23202", name: "常見機器學習演算法", count: 13 },
    { code: "L23203", name: "深度學習原理與框架", count: 13 },
    { code: "L23301", name: "數據準備與特徵工程", count: 11 },
    { code: "L23302", name: "模型選擇與架構設計", count: 11 },
    { code: "L23303", name: "模型訓練、評估與驗證", count: 11 },
    { code: "L23304", name: "模型調整與優化", count: 11 },
    { code: "L23401", name: "數據隱私、安全與合規", count: 11 },
    { code: "L23402", name: "演算法偏見與公平性", count: 11 },
  ],
